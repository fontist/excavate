...
Excavate supports the following archive formats:
...
Recursive extraction allows nested archives to be extracted automatically.
...
----
target = Dir.mktmpdir
Excavate::Archive.new("path/to/archive.tar.xz").extract(target)
----
